  ...
  return (
    <section className="mx-auto max-w-4xl space-y-6 px-4 py-10">
      ...
      <ContentBlock
        ...
        text="A szolgáltatás magánszemély vásárlók számára vehető igénybe; a számlát a Szolgáltató magánszemély vevő nevére állítja ki. A felhasználónak ki kell töltenie az adatlap és a számlázási adatok minden kötelező mezőjét. A felhasználónak el kell fogadnia az ÁSZF-et és az Adatkezelési tájékoztatót, majd sikeres bankkártyás fizetést kell végrehajtania. A fizetési folyamat a Stripe Checkout felületen zajlik – a bankkártya adatokat a Stripe dolgozza fel, azok nem kerülnek a Szolgáltató rendszereibe. A feltüntetett árak a fizetendő végösszegek. A Szolgáltató alanyi adómentes, ezért a számlán áthárított általános forgalmi adó nem szerepel. Az ár megrendelés közben nem változtatható; a Szolgáltató kizárólag az általa meghatározott díjat fogadja el."
      />
      <ContentBlock
