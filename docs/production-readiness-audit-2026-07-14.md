...
Külső konfigurációs státusz frissítése: 2026-07-18
...
- **Javítás:** könyvelővel egyeztetett checksum és opcionális szolgáltatói elővalidáció; világos javítási workflow; a hard-coded 27% és elállási/számlázási szöveg jogi-könyvelői review-ja.
...
5. **Számlázz.hu:** külön teszt account Agent kulcs és live account Agent kulcs; eladóadatok és 27% ÁFA könyvelői jóváhagyása; sztornó/helyesbítő/refund folyamat. A Számla Agent kulcs a Vezérlőpult „Számla Agent Kulcsok” részén hozható létre: [Számlázz.hu ÁSZF](https://www.szamlazz.hu/wp-content/uploads/2025/09/Sza%CC%81mla%CC%81zz.hu-A%CC%81SZF-2025.10.01.pdf).
...
4. **Számlázz.hu:** a Vezérlőpult → Számla Agent Kulcsok részen legyen külön teszt- és live `SZAMLAZZ_AGENT_KEY`; könyvelővel ellenőrizd a seller adatokat, 27% ÁFÁ-t, refund/storno/helyesbítő folyamatot.
